...
# Train model
print("Training...")
models, val_pred, test_pred = train_nn(X_train, y_train, X_val, y_val, X_test,
                                       epoch=500,
...
make_submission(df_train, df_test, df_sales, test_pred, zero_forecast=True, name='nn_submission.csv')
